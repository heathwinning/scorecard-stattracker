...
import { HiOutlineTemplate, HiOutlineClipboardList, HiOutlineViewGrid } from "react-icons/hi";

const navLinks = [
  { href: "/dashboard", label: "Dashboard", icon: HiOutlineViewGrid },
  { href: "/templates", label: "Scorecards", icon: HiOutlineTemplate },
  { href: "/scorecards", label: "My Scores", icon: HiOutlineClipboardList },
];
      ...
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="text-lg font-bold text-slate-900 tracking-tight">Scorecard StatTracker</span>
          </Link>
          {(user || isGuest) && (
