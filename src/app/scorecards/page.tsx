  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 page-enter">
      <div className="page-header">
        ...
        {user && (
          <Link href="/scorecards/new" className="btn-primary">
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          {user && <Link href="/scorecards/new" className="btn-primary text-sm mt-2"><HiOutlinePlus className="w-4 h-4" /> Create Scorecard</Link>}
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {templates.map((tpl) => (
